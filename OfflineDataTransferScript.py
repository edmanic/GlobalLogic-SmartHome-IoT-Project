...
def main():
    ...
    port = 1883
    # time when connection with server failed given as system argument
    print(sys.argv[1])
    ...
    db = clientdb.house
    posts = db.room
    # getting current time+2 seconds for good measure
    now = (datetime.datetime.now() + datetime.timedelta(seconds=2))
    # getting time when connection lost with server and adding
